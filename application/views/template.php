...
<head>
    ...
    <title>Admin|Wedo Entertainment</title>
	...
	//  $profile = $CI->common->accessrecord(TBL_USER,[],['id'=>adminid()],'row');
    ...
    <div id="containerbar">
       ...
       <?php $this->load->view('admin/layout/sidebar');?>
        ...
        <div class="rightbar">
            ...
            <div class="footerbar">
                <footer class="footer">
                    <p class="mb-0">© 2020 Wedo Entertainment - All Rights Reserved.</p>
                </footer>
                <button style="display:none;" id="showrt" onclick="notification();">fdf</button>
            </div>
        </div>
    </div>
    <?php 
